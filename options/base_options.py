...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--alpha', default=6, type=int, help='scaling (see LoRA paper)')
        parser.add_argument('--dropout_rate', default=0.8, type=float, help='dropout rate applied before the LoRA module')
